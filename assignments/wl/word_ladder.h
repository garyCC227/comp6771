...
// word_type  = (word string, [previous_position_for_change_char_for_the_current_word, how many char are same as d_word])
...
using PossWordMap = std::unordered_map<std::string, std::priority_queue<WordType, std::vector<WordType>, CustomCompare>>;
